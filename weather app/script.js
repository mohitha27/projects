async function fetchWeather() {
  ...
  console.log(searchInput, "My console output");
  const weatherDataSection = document.getElementById('weather-data');
  weatherDataSection.style.display = 'block';

  const apiKey = "33736b6bbfba5560d882445d3884c2a4"
  ...
  async function getWeatherData(lon, lat) {
    ...
    const weatherURL = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=${apiKey}` //endpoint
